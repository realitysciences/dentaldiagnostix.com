    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { background: #F7F5F0; color: #1A2B3C; font-family: 'DM Sans', sans-serif; }
        ...
        @media (max-width: 640px) {
          ...
          .report-row { flex-direction: column !important; gap: 8px !important; }
          .report-body { padding: 1.25rem !important; }
          .pricing-grid { grid-template-columns: 1fr !important; }
          .faq-grid { grid-template-columns: 1fr !important; }
          .footer-inner { flex-direction: column !important; gap: 8px !important; }
          .section-pad { padding-left: 1.25rem !important; padding-right: 1.25rem !important; }
          .nav-inner { padding: 0 1.25rem !important; }
          .report-card { margin: 0 1rem 4rem !important; }
      ...
      <nav style={{
        ...
        <div className="nav-inner" style={{
          ...
          <a href="/" style={{ textDecoration: "none" }}>
            ...
            <sup style={{ fontSize: 9, color: "#0E6B5E", verticalAlign: "super", lineHeight: 0 }}>&trade;</sup>
          </a>
          <div className="nav-links" style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
            <div className="nav-links-text" style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
      ...
      <section style={{ textAlign: "center", padding: "5rem 2rem 3rem", maxWidth: 860, margin: "0 auto" }}>
        <p style={{
          ...
          color: "#0E6B5E", marginBottom: 20, fontWeight: 500,
        }}>Behavioral terrain mapping for dental practices</p>
      ...
      {/* SAMPLE REPORT CARD */}
      <div id="sample-report" className="report-card" style={{
        ...
        <div style={{
          ...
          }}>DentalDiagnostix &mdash; Patient Behavioral Report</span>
          <span style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 11, color: "#7DD4C4" }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#7DD4C4", display: "inline-block" }} />
            Report ready &middot; Generated 2 hours before appointment
          </span>
        </div>

        {/* Report body */}
        <div className="report-body" style={{ padding: "2rem 2.5rem" }}>

          {/* Patient row */}
          <div className="report-row" style={{
            display: "flex", justifyContent: "space-between", alignItems: "flex-start",
            borderBottom: "0.5px solid #E2DDD5", paddingBottom: "1.5rem", marginBottom: "1.75rem",
            gap: 16,
          }}>
            <div>
          ...
          <div className="four-col" style={{
            ...
            {[
              ...
              <div key={s.label} style={{
                background: "#F7F5F0", borderRadius: 8, padding: "14px",
              }}>
      ...
      <section className="section-pad" style={{ padding: "5rem 3rem", maxWidth: 900, margin: "0 auto" }}>
        <div className="two-col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          ...
          <div className="intake-card" style={{ background: "#fff", border: "0.5px solid #E2DDD5", borderRadius: 12, overflow: "hidden" }}>
            {/* Card header */}
            ...
            {[
              {
                num: "Question 3 of 8",
                q: "When you think about the last time you went to the dentist, what comes up for you?",
                a: "Honestly, embarrassment. It had been too long and I just kept putting it off. I felt like they were going to judge me.",
              },
              {
                num: "Question 5 of 8",
                q: "Is there anything you would want a dentist to know about you before you come in?",
                a: "Just that I am not someone who does not care. Life got in the way. I do care.",
              },
              {
                num: "Question 7 of 8",
                q: "If a dentist recommended treatment you were not expecting, how would you typically handle that?",
                a: "I would probably say yes and then need to think about the cost. I do not love bringing money up in the moment.",
              },
            ].map((item, i, arr) => (
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" style={{ background: "#fff", borderTop: "0.5px solid #E2DDD5", borderBottom: "0.5px solid #E2DDD5", padding: "5rem 3rem" }}>
        <div className="section-pad" style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div className="three-col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "3rem" }}>
            {[
              {
                n: "01",
                title: "Patient completes the intake",
                body: "A link goes out alongside your existing appointment confirmation. The intake takes about 8 minutes. It asks about the relationship they have with their mouth, their past providers, and the patterns underneath their avoidance.",
              },
              {
                n: "02",
                title: "Terrain is mapped",
                body: "Responses are analyzed using a behavioral methodology built on a decade of psychological terrain work, developed by a dentist who spent years wondering why the same patients kept failing treatment no matter what was clinically done.",
              },
              {
                n: "03",
                title: "Report arrives before the appointment",
                body: "You receive a one-page behavioral briefing: avoidance pattern, compliance risk, legal flags, dentist history, and specific dos and donts. Two minutes of reading. A completely different appointment.",
              },
            ].map((s) => (
              <div key={s.n}>
        ...
        <div className="two-col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: "#4A5568" }}>
              <strong style={{ color: "#1A2B3C", fontFamily: "DM Sans, sans-serif" }}>David Benson, DDS</strong>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            {[
              {
                title: "Not a tech company guessing at dentistry",
                body: "DentalDiagnostix was built by someone who has sat in the operatory, managed treatment resistance, and navigated difficult patients without any of this information.",
              },
              {
                title: "The methodology exists outside dentistry",
                body: "The underlying behavioral terrain framework has been applied across hundreds of psychology sessions. DentalDiagnostix is a purpose-built vertical application of that methodology.",
              },
              {
                title: "Not a clinical tool",
                body: "Behavioral intake only. No diagnoses, no treatment recommendations, no clinical liability. Just the context you never had before the patient sat down.",
              },
            ].map((f) => (
      ...
      {/* TESTIMONIALS */}
      <section style={{ background: "#fff", borderTop: "0.5px solid #E2DDD5", borderBottom: "0.5px solid #E2DDD5", padding: "4rem 3rem" }}>
        <div className="section-pad" style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div className="two-col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem" }}>
            {[
              {
                quote: "The shame versus fear distinction alone would have changed how I opened at least three appointments last month. I would have walked in and said all the wrong things.",
                name: "Dr. R.A.",
                title: "General dentist, 14 years practice",
              },
              {
                quote: "I have used intake forms my whole career. I have never had one tell me a patient might leave a review before I have even met them. That is a different category of tool.",
                name: "Dr. K.L.",
                title: "Prosthodontist, group practice",
              },
            ].map((t) => (
              <div key={t.name} style={{ background: "#F7F5F0", border: "0.5px solid #E2DDD5", borderRadius: 10, padding: "1.5rem" }}>
                ...
                <p style={{ fontSize: 11, color: "#4A5568" }}>
                  <strong style={{ color: "#1A2B3C", fontFamily: "DM Sans, sans-serif" }}>{t.name}</strong>
                  {" "}&middot; {t.title}
                </p>
              </div>
            ))}
      ...
      {/* PRICING */}
      <section id="pricing" style={{ background: "#1A2B3C", padding: "5rem 3rem" }}>
        <div className="section-pad" style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div className="pricing-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", maxWidth: 660 }}>
            {/* Solo */}
            <div style={{ background: "rgba(255,255,255,0.06)", border: "0.5px solid rgba(255,255,255,0.12)", borderRadius: 12, padding: "2rem" }}>
              ...
              <p style={{ fontFamily: "Lora, Georgia, serif", fontSize: 38, color: "#fff", marginBottom: 4 }}>
                $249<span style={{ fontSize: 12, color: "rgba(255,255,255,0.4)" }}>/month</span>
              </p>
              ...
              {["Full terrain report with dos and donts", "Legal risk flag system", "Dentist history summary", "PDF export for patient record"].map((f) => (
                <p key={f} style={{ fontSize: 13, color: "rgba(255,255,255,0.65)", marginBottom: 8, display: "flex", alignItems: "flex-start", gap: 8 }}>
                  <span style={{ color: "#0E6B5E", fontSize: 16, lineHeight: "20px" }}>·</span>{f}
                </p>
              ))}
              <a href="#" style={{
                display: "block", marginTop: 24, padding: "11px", textAlign: "center",
            ...
            <div style={{ background: "#0E6B5E", border: "0.5px solid rgba(255,255,255,0.12)", borderRadius: 12, padding: "2rem" }}>
              ...
              <p style={{ fontFamily: "Lora, Georgia, serif", fontSize: 38, color: "#fff", marginBottom: 4 }}>
                $549<span style={{ fontSize: 12, color: "rgba(255,255,255,0.6)" }}>/month</span>
              </p>
              ...
              {["Everything in Solo", "Multi-provider dashboard", "Compliance trend analytics", "Priority support"].map((f) => (
                <p key={f} style={{ fontSize: 13, color: "rgba(255,255,255,0.85)", marginBottom: 8, display: "flex", alignItems: "flex-start", gap: 8 }}>
                  <span style={{ fontSize: 16, lineHeight: "20px" }}>·</span>{f}
                </p>
              ))}
              <a href="#" style={{
                display: "block", marginTop: 24, padding: "11px", textAlign: "center",
                background: "#fff", borderRadius: 8,
                color: "#0E6B5E", textDecoration: "none", fontSize: 14, fontWeight: 500,
              }}>Request demo</a>
            </div>
          </div>
        </div>
      ...
      {/* FAQ */}
      <section style={{ background: "#F7F5F0", padding: "5rem 3rem" }}>
        <div className="section-pad" style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div className="faq-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem 4rem" }}>
            {[
              {
                q: "Does this connect to my practice management software?",
                a: "Not through a direct integration at launch. The report arrives as a PDF you can attach to the patient record in any PMS. Direct integrations with Dentrix, Eaglesoft, and Open Dental are on the roadmap for later this year.",
              },
              {
                q: "What if my patient does not complete the intake?",
                a: "You get a notification that no report is available and the appointment proceeds normally. Completion rates in early testing are around 74 percent for new patients when the link arrives with the confirmation text.",
              },
              {
                q: "Is this meant to replace my existing intake forms?",
                a: "No. Your existing forms handle medical history, insurance, and consent. DentalDiagnostix runs alongside them and handles the one thing they were never designed to do: understand the person behind the patient.",
              },
              {
                q: "Who sees the patient's responses?",
                a: "Only the report is delivered to the practice, not the raw intake text. The report is what the analysis produced, not a transcript of what the patient said. This is an important distinction for patient comfort and practice-side workflow.",
              },
              {
                q: "How do I know the reports are accurate?",
                a: "The methodology was developed over a decade of applied behavioral terrain work across hundreds of sessions. Dentists in early access have consistently described the reports as recognizable when measured against patients they later met in the chair.",
              },
              {
                q: "Is this only for new patients?",
                a: "Primarily yes. New patient appointments are where the information gap is largest. A version for returning patients who have lapsed or shown compliance issues is in development.",
              },
            ].map((f) => (
              <div key={f.q}>
      ...
      {/* FINAL CTA */}
      <section style={{ background: "#0E6B5E", padding: "5rem 3rem", textAlign: "center" }}>
        <h2 style={{ fontFamily: "Lora, Georgia, serif", fontSize: 36, fontWeight: 400, color: "#fff", marginBottom: 16, lineHeight: 1.25 }}>
        ...
        <a href="#" style={{
          display: "inline-block", background: "#fff", color: "#0E6B5E",
      ...
      {/* FOOTER */}
      <footer style={{ background: "#F7F5F0", borderTop: "0.5px solid #E2DDD5", padding: "2rem 3rem" }}>
        <div className="footer-inner section-pad" style={{ maxWidth: 900, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
